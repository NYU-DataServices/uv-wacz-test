...
## 6. Check results
1. Look for the result in the `/crawls/collections` folder within `uv-wacz-test-main`. You should see a folder named like the URL and, within it, find a bunch of files including a `MY_URL.wacz` file.
